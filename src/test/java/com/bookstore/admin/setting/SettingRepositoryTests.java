...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("SITE_NAME", "LeLivre", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "logo.jpg", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2021 LeLivre", SettingCategory.GENERAL);
